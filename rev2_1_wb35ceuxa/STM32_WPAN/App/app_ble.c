...
/**
 * @file app_ble.c
 * @brief Application file for BLE Middleware.
 */
/*
 ******************************************************************************
 ...
 */
uint8_t ad_data[19] = {
    11, AD_TYPE_COMPLETE_LOCAL_NAME, 'N', 'i', 'x', 'i', 'e', 'C', 'l', 'o', 'c', 'k',  /* Complete name */
    3, AD_TYPE_APPEARANCE, 0x00, 0x01, /* GENERIC_CLOCK_APPEARANCE */
 ...
 * Scan response data
 */
uint8_t scan_data[18] = {
    17, AD_TYPE_128_BIT_SERV_UUID, 0x46, 0x3F, 0x66, 0xCA, 0x50, 0x34, 0xB9, 0x81, 0xB0, 0x44, 0x08, 0xF9, 0x00, 0x75, 0x00, 0x00,
};
/* USER CODE END PV */
...
static void Ble_Hci_Gap_Gatt_Init(void){
  ...
  uint16_t ppcp[4] = {0x0006, 0x0006, 0, 0xFFFF};
  /*
  ...
  if (aci_gatt_update_char_value(gap_service_handle,
                                gap_appearance_char_handle + 2,
                                0,
                                8,
                                (uint8_t *)&ppcp))
  {
    BLE_DBG_SVCCTL_MSG("Preferred Peripheral Connection Parameters aci_gatt_update_char_value failed.\n");
  }
  /*
...
static void Adv_Request(APP_BLE_ConnStatus_t New_Status)
{
  ...
  hci_le_set_scan_response_data(sizeof(scan_data), (uint8_t*) scan_data);
