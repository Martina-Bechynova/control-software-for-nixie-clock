 ...
 */
#define CFG_GAP_DEVICE_NAME             "NIXIE CLOCK"
 ...
 */
#define CFG_BLE_NUM_GATT_SERVICES   17
 ...
 */
#define CFG_BLE_OPTIONS  (SHCI_C2_BLE_INIT_OPTIONS_LL_HOST | SHCI_C2_BLE_INIT_OPTIONS_NO_SVC_CHANGE_DESC | SHCI_C2_BLE_INIT_OPTIONS_DEVICE_NAME_RO | SHCI_C2_BLE_INIT_OPTIONS_POWER_CLASS_2_3)
...
#define CFG_RTC_SYNCH_PRESCALER (255)
...
/* USER CODE BEGIN CFG_Task_Id_With_HCI_Cmd_t */
    CFG_TASK_NIXIE_NOTIFY_GATT_CLOCK_DATETIME_ID,
    CFG_TASK_NIXIE_NOTIFY_GATT_TIMER_TIME_ID,
    CFG_TASK_NIXIE_NOTIFY_GATT_TIMER_STATUS_ID,
    CFG_TASK_NIXIE_NOTIFY_GATT_STOPWATCH_TIME_ID,
...
/* USER CODE BEGIN CFG_Task_Id_With_NO_HCI_Cmd_t */
    CFG_TASK_NIXIE_UPDATE_DATETIME_ID,
    CFG_TASK_NIXIE_UPDATE_DISPLAY_ID,
    CFG_TASK_NIXIE_UPDATE_LED_ID,
    CFG_TASK_NIXIE_PROCESS_USER_ALARM_ID,
    CFG_TASK_NIXIE_PROCESS_ACCLRM_ACT_ID,
    CFG_TASK_NIXIE_PROCESS_TIMER_END_ID,
    CFG_TASK_NIXIE_PROCESS_HOURLY_ALARM_ID,
